        ...
        <div className="service-items">
          <div className="service-col">
            <div className="service-item">
              ...
              <div className="name">Medical research</div>
              <div className="single-post-text">
                <p>
                  Accelerates your healthcare breakthroughs. We design custom
                  studies, analyze data, and deliver insights to fight disease
